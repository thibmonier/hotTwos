 ...
 */
final class Version20260904153527 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'US-068 (T-068-05) : table reset_password_request (selector/hashed_token + expiration, FK app_user). Table anonyme, hors RLS tenant.';
    }
