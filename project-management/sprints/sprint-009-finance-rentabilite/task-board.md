...
|----|-----|-------|------------|
| T-071-08 | US-071 | [DOC] ADR léger « facturable = CA reconnu » | 1h |
| T-071-01 | US-071 | [DB] Entité `ProjectMargin` + port repo | 3h |
| T-071-02 | US-071 | [DB] Migration `project_margin` (RLS, unique) | 2h |
| T-071-03 | US-071 | [BE] `MarginCalculator` (domaine) | 2h |
| T-071-04 | US-071 | [BE] Use case `ComputeProjectMargins` (à la clôture) | 4h |
| T-071-05 | US-071 | [BE] Branchement clôture (US-057, async) | 2h |
| T-071-06 | US-071 | [BE] Lecture marges figées + gating HAB-1 | 2h |
| T-071-07 | US-071 | [TEST] Tests (marge, non-rétroactif, partiel, gating) | 3h |
| T-071-09 | US-071 | [REV] Revue de clôture | 1h |
...
## Métriques
- **Tâches** : 24 engagées (+5 réserve) · 0 terminée (0 %)
- **Heures** : 55h engagées (+9.5h réserve) · 0h consommées
- **Points** : 21 engagés (US-071/072/073) ; US-074 (5) en réserve
