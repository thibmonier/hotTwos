...
|----|-------|--------|---------|--------|
| TECH-1 | Migrations Doctrine + durcissement analytique versionné (RLS + trigger) | 5 | Rétro S1 · Action 1 | 🔵 To Do |
| TECH-2 | RLS active au runtime par requête (rôle applicatif dédié) — finition US-001 | 5 | Rétro S1 · Action 2 | 🔵 To Do |
