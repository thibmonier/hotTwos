...
| US-017 | Circuit de validation des absences paramétrable | ✅ Done | 17 | EF-REF-24/25 |
| US-021 | Calendriers de travail différenciés (temps partiel) | ✅ Done | 17 | EF-REF-7 |
| US-022 | Périodes de fermeture entreprise | ✅ Done | 17 | EF-REF-9 |
...
| EF-REF-25 (circuits de validation) | M | ✅ | Circuit multi-étapes paramétrable (flux absences, US-017 S17). EF-REF-24 transitions de statut : reporté (enum). |
